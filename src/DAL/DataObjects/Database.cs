...
namespace FountainContext.Data.Models
{
	public partial class FountainDb : Database
	{
		...
		public partial class PureLoan : FountainDb.Record<PureLoan>  
		{
			...
			[Column("Guarantor1PhoneNo")] public string Guarantor1phoneno 
			{ 
				get { return _Guarantor1phoneno; }
				set { _Guarantor1phoneno = value; Track("Guarantor1PhoneNo"); }
			}
			string _Guarantor1phoneno;
		...
		public partial class PureDeposit : FountainDb.Record<PureDeposit>  
		{
			...
			[Column("DepositorNo")] public string Depositorno 
			{ 
				get { return _Depositorno; }
				set { _Depositorno = value; Track("DepositorNo"); }
			}
			string _Depositorno;
		...
		public partial class PureCustomerInfo : FountainDb.Record<PureCustomerInfo>  
		{
			...
			string _Useremail;
			[Column("PhoneNo1")] public string Phoneno1 
			{ 
				get { return _Phoneno1; }
				set { _Phoneno1 = value; Track("PhoneNo1"); }
			}
			string _Phoneno1;
			[Column("PhoneNo2")] public string Phoneno2 
			{ 
				get { return _Phoneno2; }
				set { _Phoneno2 = value; Track("PhoneNo2"); }
			}
			string _Phoneno2;
		...
		public partial class PureRepayment : FountainDb.Record<PureRepayment>  
		{
			...
			string _Transref;
			[Column("ReceiptNo")] public string Receiptno 
			{ 
				get { return _Receiptno; }
				set { _Receiptno = value; Track("ReceiptNo"); }
			}
			string _Receiptno;
		...
		public partial class PureAccountNo : FountainDb.Record<PureAccountNo>  
		{
			...
			public static IEnumerable<PureAccountNo> Query(Database db, string[] columns = null, int[] Accountid = null)
            {
                ...
                sql.From("dbo.Pure_AccountNo (NOLOCK)");
		...
		public partial class PureTillHistory : FountainDb.Record<PureTillHistory>  
		{
			...
			public static IEnumerable<PureTillHistory> Query(Database db, string[] columns = null, int[] Tillid = null)
            {
                var sql = new Sql();
